      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {skills.map((skill) => (
            <div
              key={skill.name}
              className="p-4 bg-gray-800 rounded-lg shadow-lg transition-transform hover:scale-105"
            >
              {/* Skill Name */}
              ...
              <div className="relative pt-1">
                ...
                <div className="relative w-full h-2 bg-gray-700 rounded-full">
                  <div
                    className="absolute top-0 left-0 h-2 bg-cyan-400 rounded-full transition-all"
                    style={{ width: `${skill.level}%` }}
                  ></div>
                </div>
              </div>
